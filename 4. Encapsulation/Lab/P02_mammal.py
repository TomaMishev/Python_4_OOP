...
# more instance methods: •	make_sound() - returns a string in the format "{name} makes {sound}" •	get_kingdom() -
# returns the private kingdom attribute •	info() - returns a string in the format "{name} is of type {type}"
