# Refactor the provided code, so we do not need to do any type-checking. The classes should implement the method to
# return the number of sensors for each type of robot.
